...
int main(){   int mark;   printf(" Enter Your Mark:");   scanf("%d",&mark);   if(mark >= 80)AP     else if(mark >=75 && mark<80)A     else if(mark >=70 && mark<75)AM     else if(mark >=65 && mark<70)BP     else if(mark >=60 && mark<65)B     else if(mark >=55 && mark <60)BM     else if(mark >=50 && mark<55)CP     else if(mark >=45 && mark<50)C     else if(mark >=40 && mark<45)D 
    else F 
